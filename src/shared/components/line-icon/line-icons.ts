...
export const EMOJI_ICONS: Record<string, ReadonlyArray<IconShape>> = {
  ...
  '🛠': [
    [
      'path',
      {
        d: 'M14.5 3a5.5 5.5 0 00-4.9 8L3 17.6V21h3.4l6.6-6.6A5.5 5.5 0 0020.5 6.5l-3 3-2.5-2.5 3-3A5.5 5.5 0 0014.5 3z',
      },
    ],
  ],
  '🔧': [
  ...
  '🎨': [
    [
      'path',
      {
        d: 'M12 3a9 9 0 100 18c1.7 0 2.5-1 2.5-2.2 0-1.4-1-2-1-3.3 0-1 .8-1.7 1.8-1.7H17a4 4 0 004-4c0-3.9-4-6.8-9-6.8z',
      },
    ],
  ...
  '🎮': [
    [
      'path',
      {
        d: 'M7 7h10a5 5 0 014.8 6.3l-1 3.8a2.5 2.5 0 01-4.3 1L15 16.5H9l-1.5 1.6a2.5 2.5 0 01-4.3-1l-1-3.8A5 5 0 017 7z',
      },
    ],
    ['path', { d: 'M8 10.5v3M6.5 12h3M15 11.5h.01M17.5 13h.01' }],
  ],
  '🌪️': [['path', { d: 'M4 5h16M6 9h12M8 13h8M10 17h4M11.5 21h1' }]],
  '🎫': [
    [
      'path',
      {
        d: 'M3 8.5a2 2 0 002-2h14a2 2 0 002 2v2a2 2 0 000 3v2a2 2 0 00-2 2H5a2 2 0 00-2-2v-2a2 2 0 000-3z',
      },
    ],
    ['path', { d: 'M14 7v10' }],
  ],
